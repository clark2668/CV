...
\vspace*{-.15in}
\begin{list1}
\item[] Ph.D. Student in Physics--Advisor: Prof. Amy Connolly
\item [] Master of Science, June 2016
\end{list1}
...
\begin{etaremune}%[leftmargin=0.64cm]
 ...
 P. Allison et. al. for the ARA Collaboration (incl. B. A. Clark) \\
...
\begin{rSection}{SCIENTIFIC TALKS (1 Invited, 7 Contributed)}
\begin{etaremune}
...
{\bf Graduate Students:} Jorge Torres-Espinosa, Keith McBride \\
