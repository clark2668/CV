...
\begin{etaremune}%[leftmargin=0.64cm]
  \item ``Design and Performance of an Interferometric Trigger Array for the Radio Detection of High-Energy Neutrinos" \\
 P. Allison {\it et. al.} for the ARA Collaboration (incl. \textbf{B. A. Clark}) \\
 Submitted to Nuclear Instruments and Methods A (2018). \href{tbd}{arXiv:1809.XXXXX}
...
\begin{rSection}{SCIENTIFIC TALKS (1 Invited, 9 Contributed)}
\begin{etaremune}

\item Talk, Ohio Section of the APS Fall 2018 Meeting, Toledo OH. \hfill 2018/09/29 \\
\href{http://www.utoledo.edu/nsm/physast/osaps/}{\em Latest Results in the Search for Ultra-High Energy Neutrinos in the Askaryan Radio Array} 
