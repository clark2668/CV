...
\vspace*{-.15in}
\begin{list1}
\item[] \textit{Cum Laude}
\item[]Advisor: Prof. Henric Krawczynski
\end{list1}
\end{rSection}
%\vspace{0.25cm}
...
\begin{itemize}
\vspace*{.05in}
\item Developed simulation, hardware, and analysis tools for the radio-detection of ultra-high energy neutrinos in the Askaryan Radio Array (ARA).
...
%\item Wrote Monte Carlo simulations to explore Stokes parameters in x-ray astronomy by using method of Bayesian confidence intervals.
%\end{list2}
\end{rSection}
...
\begin{itemize}
\vspace*{-.05in}
\item Guided student learning in recitation and laboratory context for four contact hours per week.
